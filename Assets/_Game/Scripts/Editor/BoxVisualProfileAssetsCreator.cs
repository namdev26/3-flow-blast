...
namespace FlowBlast.Editor
{
    public static class BoxVisualProfileAssetsCreator
    {
        ...
        private static readonly ProfileSeed[] ProfileSeeds =
        {
            ...
            new ProfileSeed("DarkBrown_Color", BlockColor.None, new Color(0.46f, 0.29f, 0.13f)),
            new ProfileSeed("DarkGreen_Color", BlockColor.Green, new Color(0.05f, 0.65f, 0.05f)),
            new ProfileSeed("LightBlue_color", BlockColor.Blue, new Color(0.35f, 0.82f, 0.95f)),
            new ProfileSeed("Gray_Color", BlockColor.None, new Color(0.42f, 0.46f, 0.58f)),
            new ProfileSeed("Purple_Color", BlockColor.Purple, new Color(0.52f, 0.25f, 0.95f)),
            new ProfileSeed("LightGray_Color", BlockColor.None, new Color(0.72f, 0.78f, 0.92f)),
            new ProfileSeed("White_Color", BlockColor.None, Color.white),
            new ProfileSeed("LightPurple_Color", BlockColor.Purple, new Color(0.82f, 0.57f, 0.95f)),
            new ProfileSeed("TealGreen_Color", BlockColor.Cyan, new Color(0.14f, 0.68f, 0.57f)),
            new ProfileSeed("Yellow_Color", BlockColor.Yellow, new Color(1f, 0.84f, 0.1f)),
            new ProfileSeed("Orange_Color", BlockColor.Yellow, new Color(1f, 0.55f, 0.15f)),
            new ProfileSeed("SkyBlue_Color", BlockColor.Cyan, new Color(0.43f, 0.7f, 0.97f)),
            new ProfileSeed("Pink_color", BlockColor.Purple, new Color(0.94f, 0.15f, 0.76f)),
